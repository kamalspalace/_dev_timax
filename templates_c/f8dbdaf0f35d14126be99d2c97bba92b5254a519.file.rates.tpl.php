<?php /* Smarty version Smarty-3.1.12, created on 2013-03-30 22:01:17
         compiled from "/home/shipon/public_html/new_bol/timax/templates/shipment/boxes/rates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:125493342950fa01d4805a38-11608026%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8dbdaf0f35d14126be99d2c97bba92b5254a519' => 
    array (
      0 => '/home/shipon/public_html/new_bol/timax/templates/shipment/boxes/rates.tpl',
      1 => 1364695261,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '125493342950fa01d4805a38-11608026',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_50fa01d4842196_04155690',
  'variables' => 
  array (
    'id' => 0,
    'lang' => 0,
...
<?php if ($_valid && !is_callable('content_50fa01d4842196_04155690')) {function content_50fa01d4842196_04155690($_smarty_tpl) {?>
...
<?php }else{ ?>-<?php }?></td>
	...
	<div class='shipon_fieldblock' style='width: 55%;'>
        ...
        <div class='shipon_fieldblock' style='width: 45%; margin-top: 5px;'>
		<label style='width: 105px; text-align:	right; font-size: 14px; font-weight: bold;'><?php echo $_smarty_tpl->tpl_vars['lang']->value['fuelsc'];?>
:&nbsp;</label>
...
<?php }else{ ?>0.00<?php }?>" readonly='readonly' />
		...
		<label style='width: 105px; text-align: right; font-size: 14px; font-weight: bold;'><?php echo $_smarty_tpl->tpl_vars['lang']->value['subtotal'];?>
:&nbsp;</label>
...
<?php }else{ ?>0.00<?php }?>" readonly='readonly' />
        ...
        <div class='shipon_fieldblock' style='width: 45%;'>
		<label style='width: 105px; text-align: right; font-size: 14px; font-weight: bold;'><?php echo $_smarty_tpl->tpl_vars['lang']->value['tax'];?>
:&nbsp;</label>
...
<?php }else{ ?>0.00<?php }?>" readonly='readonly' />
        ...
        <div class='shipon_fieldblock' style='width: 45%;'>
		<label style='width: 105px; text-align: right; font-size: 14px; font-weight: bold;'><?php echo $_smarty_tpl->tpl_vars['lang']->value['total'];?>
:&nbsp;</label>
