<?php /* Smarty version Smarty-3.1.12, created on 2013-10-25 21:38:18
         compiled from "/home/shipon/public_html/new_bol/_pro-timax/templates/tracking/tracking_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1179779170525593962a9b82-35766324%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ceaeb5fb4f2920899645337a7208f788a2e6112a' => 
    array (
      0 => '/home/shipon/public_html/new_bol/_pro-timax/templates/tracking/tracking_view.tpl',
      1 => 1382751494,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1179779170525593962a9b82-35766324',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_525593966a3492_94044072',
  'variables' => 
  array (
    'lang' => 0,
    'request' => 0,
...
<?php if ($_valid && !is_callable('content_525593966a3492_94044072')) {function content_525593966a3492_94044072($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/shipon/public_html/new_bol/_CORE/includes/smarty/libs/plugins/modifier.replace.php';
...
');">&#xe024;</a>
                <a class='shipon_tracking_button' href="#dsfd">&#xe00a;</a>
                    <?php if (isset($_smarty_tpl->tpl_vars['data']->value['internalId'])){?>
			<a class='shipon_tracking_button' href="#history#view_pdf-<?php echo $_smarty_tpl->tpl_vars['data']->value['internalId'];?>
			...
			<table id='shipon_tracking_details_info'>				
				...
				<tbody>
					<tr>
						...
						<td class='value'><?php if ($_smarty_tpl->tpl_vars['data']->value['Division']=='CUR'&&isset($_smarty_tpl->tpl_vars['data']->value['Reference2'])&&$_smarty_tpl->tpl_vars['data']->value['Reference2'][0]!=''){?><?php if (strtoupper(substr($_smarty_tpl->tpl_vars['data']->value['Reference2'],0,2))=='1Z'){?><?php echo $_smarty_tpl->tpl_vars['data']->value['RecStatus'];?>
<?php }else{ ?>Purolator<?php }?><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['settings']->value['statuses'][$_smarty_tpl->tpl_vars['data']->value['RecStatus']];?>
<?php }?></td>
					</tr>	
					<tr>
                        			...
                        			<td class='value'><?php if ($_smarty_tpl->tpl_vars['data']->value['Division']=='CUR'&&isset($_smarty_tpl->tpl_vars['data']->value['Reference2'])&&$_smarty_tpl->tpl_vars['data']->value['Reference2'][0]!=''){?><?php $_smarty_tpl->tpl_vars['curserv'] = new Smarty_variable(explode("*",$_smarty_tpl->tpl_vars['data']->value['Reference2']), null, 0);?><?php if (isset($_smarty_tpl->tpl_vars['data']->value['Reference2'])&&strtoupper(substr($_smarty_tpl->tpl_vars['data']->value['Reference2'],0,2))!='1Z'){?><a href="http://www.purolator.com/purolator/ship-track/tracking-details.page?pin=<?php echo $_smarty_tpl->tpl_vars['data']->value['Reference2'];?>
" target="_new"><?php echo $_smarty_tpl->tpl_vars['data']->value['Reference2'];?>
</a><?php }else{ ?><a href="http://wwwapps.ups.com/WebTracking/track?HTMLVersion=5.0&loc=en_CA&Requester=UPSHome&WBPM_lid=homepage%2Fct1.html_pnl_trk&track.x=Track&trackNums=<?php echo strtoupper($_smarty_tpl->tpl_vars['curserv']->value[0]);?>
" target="_new"><?php echo strtoupper($_smarty_tpl->tpl_vars['curserv']->value[0]);?>
</a><?php }?><?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['data']->value['ShBOL'][0])){?><?php echo $_smarty_tpl->tpl_vars['data']->value['ShBOL'];?>
<?php }else{ ?>-<?php }?><?php }?></td>
					</tr>	
                    <tr>
...
<?php }elseif(isset($_smarty_tpl->tpl_vars['status']->value['Olocation'][0])&&$_smarty_tpl->tpl_vars['status']->value['RecStatus']=='DSP'){?><?php $_smarty_tpl->tpl_vars['loc'] = new Smarty_variable(explode(":",$_smarty_tpl->tpl_vars['status']->value['Olocation']), null, 0);?><b><?php echo strtoupper(smarty_modifier_replace($_smarty_tpl->tpl_vars['loc']->value[0],',',', '));?>
</b><br /><?php echo substr($_smarty_tpl->tpl_vars['loc']->value[1],0,27);?>
<?php }?>
						</td>
...
<?php }else{ ?>View Signature<?php }?></a><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['status']->value['RecStatus']=='DPU'&&!isset($_smarty_tpl->tpl_vars['status']->value['Remarks'][0])){?>&nbsp;<br />&nbsp;<?php }?>
				...
				<tfoot>
                    <tr> 
                      	<td width='99%' colspan='4' style='text-align: center;'><?php if (isset($_smarty_tpl->tpl_vars['data']->value['Reference2'])&&strtoupper(substr($_smarty_tpl->tpl_vars['data']->value['Reference2'][0],0,2))!='1Z'&&$_smarty_tpl->tpl_vars['data']->value['Reference2'][0]!=''){?>Visit the following link: <a href="http://www.purolator.com/purolator/ship-track/tracking-details.page?pin=<?php echo $_smarty_tpl->tpl_vars['data']->value['Reference2'];?>
" target="_new"><?php echo $_smarty_tpl->tpl_vars['data']->value['Reference2'];?>
</a><?php }else{ ?>NO STATUS UPDATES ON FILE<?php }?></td>
                    </tr>
				</tfoot>
				<?php }?>	
            </table>
